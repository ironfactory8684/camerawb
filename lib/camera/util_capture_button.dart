...
class UtilCaptureButton extends StatefulWidget {
  final CameraState state;
  final Function() setPreview;

  const UtilCaptureButton({
  super.key,
  required this.state, required this.setPreview,
  });

  @override
  _UtilCaptureButtonState createState() => _UtilCaptureButtonState();
}

class _UtilCaptureButtonState extends State<UtilCaptureButton>
